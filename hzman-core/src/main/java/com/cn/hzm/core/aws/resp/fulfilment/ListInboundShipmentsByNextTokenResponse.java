 ...
 */
@Data
@XStreamAlias("ListInboundShipmentsByNextTokenResponse")
public class ListInboundShipmentsByNextTokenResponse {

    @XStreamAlias(value = "ListInboundShipmentsByNextTokenResult")
    ListInboundShipmentsByNextTokenResult listInboundShipmentsByNextTokenResult;
