...
public enum AwsMarket {
    ...
    France("A13V1IB3VIYZZH", "FR", "eu-west-1", "https://sellingpartnerapi-eu.amazon.com","法国", ".uk"),
    ...
    Germany("A1PA6795UKMFR9", "DE", "eu-west-1", "https://sellingpartnerapi-eu.amazon.com","德国", ".uk"),
    Italy("APJ6JRA9NG5V4", "IT", "eu-west-1", "https://sellingpartnerapi-eu.amazon.com","意大利", ".uk"),
